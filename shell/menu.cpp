    ...
    ui(new Ui::Menu)
{
    ...
    ui->availableUsersList->setItemDelegate(new UsersListDelegate);
...
void UsersListDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const {
...
QSize UsersListDelegate::sizeHint(const QStyleOptionViewItem &option, const QModelIndex &index) const {
